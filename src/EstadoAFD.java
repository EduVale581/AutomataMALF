...
public class EstadoAFD {
    ...
    char letra;
    private ArrayList<TransicionAFD> transicionLinkeado = new ArrayList<>();
    ...
    public void addTransicionLinkeado(TransicionAFD transiciones){
       transicionLinkeado.add(transiciones);
    }
    
    public ArrayList<TransicionAFD> getTransicionLinkeado(){
        return this.transicionLinkeado;
    }
}
